...
declare const FabricAddedEvents: {
    /**
     * @at *server*
     * 
     * @cancellable
    */
setBedOccupationState(handler: (event: Internal.SetBedOccupationStateEventJS) => void):void,
    /**
     * @at *client*
    */
startRender(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowSleepTime(handler: (event: Internal.AllowSleepTimeEventJS) => void):void,
    /**
     * @at *client*
     * 
     * @cancellable
    */
beforeBlockOutline(handler: (event: Internal.BeforeBlockOutlineRenderEventJS) => void):void,
    /**
     * @at *server*
    */
modifyWakeUpPosition(handler: (event: Internal.ModifyWakeUpPositionEventJS) => void):void,
    /**
     * @at *client*
    */
renderHUD(handler: (event: Internal.HudRenderEventJS) => void):void,
    /**
     * @at *client*
    */
blockOutline(handler: (event: Internal.BlockOutlineRenderEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowBed(handler: (event: Internal.AllowBedEventJS) => void):void,
    /**
     * @at *server*
    */
modifySleepingDirection(handler: (event: Internal.ModifySleepingDirectionEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowSettingSpawn(handler: (event: Internal.AllowSettingSpawnEventJS) => void):void,
    /**
     * @at *client*
    */
beforeEntities(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *client*
    */
afterEntities(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowSleeping(handler: (event: Internal.AllowSleepingEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
customElytraFlight(handler: (event: Internal.CustomElytraFlightEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowNearbyMonsters(handler: (event: Internal.AllowNearbyMonstersEventJS) => void):void,
    /**
     * @at *client*
    */
endRender(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowElytraFlight(handler: (event: Internal.AllowElytraFlightEventJS) => void):void,
    /**
     * @at *server*
    */
startSleeping(handler: (event: Internal.SleepingEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
allowResettingTime(handler: (event: Internal.AllowResettingTimeEventJS) => void):void,
    /**
     * @at *server*
    */
stopSleeping(handler: (event: Internal.SleepingEventJS) => void):void,
    /**
     * @at *client*
    */
afterTranslucent(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *client*
    */
afterSetup(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
    /**
     * @at *client*
    */
lastRender(handler: (event: Internal.WorldRenderContextEventJS) => void):void,
};
...
declare const FabricEvents: {
    /**
     * @at *startup*
    */
registry(handler: (event: Internal.FabricEventRegisterEventJS) => void):void,
    /**
     * @at *server*
    */
handleServer(extra: string, handler: (event: Internal.ProxyEventJS) => void):void,
...
declare const CapeJS: {
    /**
     * @at *client*
    */
addCapes(handler: (event: Internal.AddCapeEventJS) => void):void,
};
...
registry(type: "serialization_hooks:ingredient_deserializers", handler: (event: Registry.IngredientDeserializers) => void):void,
registry(type: "creategoggles:item_modifier", handler: (event: Registry.ItemModifier) => void):void,
registry(type: "graphlib:block_node_decoder", handler: (event: Registry.BlockNodeDecoder) => void):void,
registry(type: "serialization_hooks:value_deserializers", handler: (event: Registry.ValueDeserializers) => void):void,
registry(type: "ae2:keytypes", handler: (event: Registry.Keytypes) => void):void,
registry(type: "graphlib:block_node_renderer", handler: (event: Registry.BlockNodeRenderer) => void):void,
registry(type: "graphlib:block_node_packet_encoder", handler: (event: Registry.BlockNodePacketEncoder) => void):void,
registry(type: "graphlib:block_node_packet_decoder", handler: (event: Registry.BlockNodePacketDecoder) => void):void,
    /**
     * @at *startup*
    */
