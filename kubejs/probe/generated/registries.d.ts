...
declare namespace Registry {
    ...
    class IngredientDeserializers extends Internal.RegistryEventJS {
    }
    class ItemModifier extends Internal.RegistryEventJS {
    }
    class BlockNodeDecoder extends Internal.RegistryEventJS {
    }
    class ValueDeserializers extends Internal.RegistryEventJS {
    }
    class Keytypes extends Internal.RegistryEventJS {
    }
    class BlockNodeRenderer extends Internal.RegistryEventJS {
    }
    class BlockNodePacketEncoder extends Internal.RegistryEventJS {
    }
    class BlockNodePacketDecoder extends Internal.RegistryEventJS {
    }
}