...
declare namespace TagEvent {
    ...
    class ItemModifier extends Internal.TagEventJS {
    get(id: Special.ItemModifierTag): Internal.TagWrapper
    add(tag: Special.ItemModifierTag, ...id: Special.ItemModifier[]): Internal.TagWrapper
    remove(tag: Special.ItemModifierTag, ...id: Special.ItemModifier[]): Internal.TagWrapper
    removeAll(tag: Special.ItemModifierTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.ItemModifier[]): Internal.TagWrapper
    }
    class BlockNodeDecoder extends Internal.TagEventJS {
    get(id: Special.BlockNodeDecoderTag): Internal.TagWrapper
    add(tag: Special.BlockNodeDecoderTag, ...id: Special.BlockNodeDecoder[]): Internal.TagWrapper
    remove(tag: Special.BlockNodeDecoderTag, ...id: Special.BlockNodeDecoder[]): Internal.TagWrapper
    removeAll(tag: Special.BlockNodeDecoderTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.BlockNodeDecoder[]): Internal.TagWrapper
    }
    class BlockNodePacketEncoder extends Internal.TagEventJS {
    get(id: Special.BlockNodePacketEncoderTag): Internal.TagWrapper
    add(tag: Special.BlockNodePacketEncoderTag, ...id: Special.BlockNodePacketEncoder[]): Internal.TagWrapper
    remove(tag: Special.BlockNodePacketEncoderTag, ...id: Special.BlockNodePacketEncoder[]): Internal.TagWrapper
    removeAll(tag: Special.BlockNodePacketEncoderTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.BlockNodePacketEncoder[]): Internal.TagWrapper
    }
    ...
    class Keytypes extends Internal.TagEventJS {
    get(id: Special.KeytypesTag): Internal.TagWrapper
    add(tag: Special.KeytypesTag, ...id: Special.Keytypes[]): Internal.TagWrapper
    remove(tag: Special.KeytypesTag, ...id: Special.Keytypes[]): Internal.TagWrapper
    removeAll(tag: Special.KeytypesTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Keytypes[]): Internal.TagWrapper
    }
    class BlockNodePacketDecoder extends Internal.TagEventJS {
    get(id: Special.BlockNodePacketDecoderTag): Internal.TagWrapper
    add(tag: Special.BlockNodePacketDecoderTag, ...id: Special.BlockNodePacketDecoder[]): Internal.TagWrapper
    remove(tag: Special.BlockNodePacketDecoderTag, ...id: Special.BlockNodePacketDecoder[]): Internal.TagWrapper
    removeAll(tag: Special.BlockNodePacketDecoderTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.BlockNodePacketDecoder[]): Internal.TagWrapper
    }
    class BlockNodeRenderer extends Internal.TagEventJS {
    get(id: Special.BlockNodeRendererTag): Internal.TagWrapper
    add(tag: Special.BlockNodeRendererTag, ...id: Special.BlockNodeRenderer[]): Internal.TagWrapper
    remove(tag: Special.BlockNodeRendererTag, ...id: Special.BlockNodeRenderer[]): Internal.TagWrapper
    removeAll(tag: Special.BlockNodeRendererTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.BlockNodeRenderer[]): Internal.TagWrapper
    }
}